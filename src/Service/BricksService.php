        ...
        return [[
            ...
            'items' => [
                ...
                [
                    'type' => 'select',
                    'name' => 'imagePos',
                    'label' => self::transAdmin('jwPimAreas.image.imagePos.label'),
                    'config' => [
                        'store' => [
                            ['top-left', self::transAdmin('jwPimAreas.image.imagePos.options.top-left')],
                            ['top-center', self::transAdmin('jwPimAreas.image.imagePos.options.top-center')],
                            ['top-right', self::transAdmin('jwPimAreas.image.imagePos.options.top-right')],
                            ['bottom-left', self::transAdmin('jwPimAreas.image.imagePos.options.bottom-left')],
                            ['bottom-center', self::transAdmin('jwPimAreas.image.imagePos.options.bottom-center')],
                            ['bottom-right', self::transAdmin('jwPimAreas.image.imagePos.options.bottom-right')],
                            ['float-left', self::transAdmin('jwPimAreas.image.imagePos.options.float-left')],
                ...
                [
                    ...
                    'label' => self::transAdmin('jwPimAreas.image.imageProportion.label'),
                    'config' => [
                        'store' => [
                            ['16-9', self::transAdmin('jwPimAreas.image.imageProportion.options.16-9')],
                            ['21-9', self::transAdmin('jwPimAreas.image.imageProportion.options.21-9')],
                            ['32-9', self::transAdmin('jwPimAreas.image.imageProportion.options.32-9')],
                            ['5-7', self::transAdmin('jwPimAreas.image.imageProportion.options.5-7')],
                            ['1-1', self::transAdmin('jwPimAreas.image.imageProportion.options.1-1')],
                            ['3-2', self::transAdmin('jwPimAreas.image.imageProportion.options.3-2')],
                            ['2-3', self::transAdmin('jwPimAreas.image.imageProportion.options.2-3')],
                            ['4-5', self::transAdmin('jwPimAreas.image.imageProportion.options.4-5')],
                            ['none', self::transAdmin('jwPimAreas.image.imageProportion.options.none')],
                            ['round', self::transAdmin('jwPimAreas.image.imageProportion.options.round')],
