...
class JwpimareasCustom extends AbstractTemplateAreabrick implements EditableDialogBoxInterface
{
    ...
    {
        return BricksService::transAdmin('jwPimAreas.custom.name');
    }
